...
from app.auth.forms import EditProfileForm,PostForm,ResetPasswordRequestForm,ResetPasswordForm
...
def user(username):
    ...
    posts = user.posts.order_by(Post.timestamp.desc()).paginate(
        page,app.config['POSTS_PER_PAGE'],False)
    next_url = url_for('auth.user',username=username,page=posts.next_num) if posts.has_next else None
    prev_url = url_for('auth.user',username=username,page=posts.prev_num) if posts.has_prev else None
